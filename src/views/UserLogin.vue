<template>
    <div class="card card-body">
      ...
      <form @submit.prevent="onSubmit">
        ...
        <div class="btn-flex">
        <button class="btn btn-main" type="submit" :disabled="loading">Submit</button>
        <button class="btn btn-login" @click="goTosignup">No Account</button>
        </div>
    ...
    setup() {
      ...
      const onSubmit = async () => {
        ...
        try {
          ...
          error.value = 'Error in Credentials or loging';
      ...
      return { email, password, onSubmit, loading, error, goTosignup };
    }
  };
  </script>
